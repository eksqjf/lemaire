$(document).ready(function(){
    ...
    // 햄버거 버튼 클릭하면 메인메뉴 나오면서 / 햄버거버튼 스위치 되도록 토글처리 / 햄버거 버튼 색상 바뀌게 처리 헤더로고 색상 바뀌게 처리
    ...
    //상단이동버튼 300px 이상일때 최상단으로 올라가는 상단이동 버튼 구현해보기 (배너에서 없어져 있다가 sec1에서부터 보이게)
    let btn = $('.top-btn');
    $(window).scroll(function(){
